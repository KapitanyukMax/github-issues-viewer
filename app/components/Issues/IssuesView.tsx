...
import { updateIssueStatus } from '@/app/store/githubSlice';
import { IssuesGroup } from './IssuesGroup';
import { IssueStatus } from '@/app/types/ui/github';
  ...
  return (
    <DndContext onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
      <div className="grid grid-cols-3 grid-rows-[auto_1fr] w-full h-full gap-x-6 gap-y-2 py-4">
        <div>
          <h2 className="font-semibold text-center">ToDo</h2>
        </div>
        <div>
          <h2 className="font-semibold text-center">In Progress</h2>
        </div>
        <div>
          <h2 className="font-semibold text-center">Done</h2>
        </div>
